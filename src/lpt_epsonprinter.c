...
void *epsonprinter_init_lpt2()
{
        void *p = epsonprinter_init();
        lpt2_device_attach(&lpt_epsonprinter_device, p);

        return p;
}
void epsonprinter_close_lpt2(void *p)
{
        epsonprinter_close(p);
        lpt2_device_detach();
}
...
device_t epsonprinter_device_lpt1 =
{
        "Epson LX-810 Printer LPT1", // Specific name so that we can have different settings on each LPT port!
        0,
...
device_t epsonprinter_device_lpt2 =
{
        "Epson LX-810 Printer LPT2", // Specific name so that we can have different settings on each LPT port!
        0,
        epsonprinter_init_lpt2,
        epsonprinter_close_lpt2,
        NULL,
        NULL,
        NULL,
        NULL,
...
lpt_device_t lpt_epsonprinter_device =
{
        ...
        epsonprinter_read_ctrl,
        &epsonprinter_device_lpt1,
        &epsonprinter_device_lpt2
};
